...
| **DNS** | CoreDNS | `serviceguard-dns-vuln` | `5353:53` (TCP/UDP) | Vulnerable | CHAOS version query disclosure, recursive query behavior |
...
serviceguard scan -i 127.0.0.1 -p 2121,2122,2323,4445,6379,6380,27017,27018,9200,11211,2375,2379,8500,3890,1025,5353,5672,15672,9090,3000,8080,8088 --verify -o lab_findings.jsonl
```
